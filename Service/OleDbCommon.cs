...
{
    public partial class OleDbCommon : ICommon
    {
        readonly IHelper<OleDbParameter, TransactionModel<OleDbParameter>> helper = new OleDbHelper();
    ...
    #region 入库
    public partial class OleDbCommon
    {
        public bool InsertPurchase(Purchase purchase,
            ObservableCollection<PurchaseDetailItem> purchaseItemCollection)
        {
            List<TransactionModel<OleDbParameter>> trans = new List<TransactionModel<OleDbParameter>>();
        ...
        {
            var trans = new List<TransactionModel<OleDbParameter>>();
        ...
        private List<TransactionModel<OleDbParameter>> UpdatePurchaseDetailTrans(
            string purchaseID,
            ObservableCollection<PurchaseDetailItem> newPurchaseItemCollection,
            ObservableCollection<PurchaseDetailItem> oldPurchaseItemCollection)
        {
        ...
        #region 删除入库单相关数据        
        private TransactionModel<OleDbParameter> DeletePurchase(string purchaseID)
        {
            string sql = "Delete From Purchase Where PurchaseID = @purchaseID";
            OleDbParameter[] pars = 
            {
                new OleDbParameter("@purchaseID",OleDbType.VarChar,50),
            };
            pars[0].Value = purchaseID;
            return new TransactionModel<OleDbParameter>(sql, pars);
        }
        private TransactionModel<OleDbParameter> DeletePurchaseDetail(string purchaseID, int productID)
        {
        ...
        private TransactionModel<OleDbParameter> DeletePurchaseDetail(string purchaseID)
        {
        ...
        #region 插入新入库单相关数据        
        private TransactionModel<OleDbParameter> InsertPurchase(Purchase purchase)
        {
            ...
            {
                new OleDbParameter("@purchaseID",OleDbType.VarChar,50),
                new OleDbParameter("@supplierID",OleDbType.Integer),
                new OleDbParameter("@attendantID",OleDbType.Integer),
                new OleDbParameter("@purchaseDate",OleDbType.Date),
                new OleDbParameter("@note",OleDbType.VarChar,50),
            };
        ...
        private TransactionModel<OleDbParameter> InsertPurchaseDetail(string purchaseID, PurchaseDetailItem item)
        {
            ...
            OleDbParameter[] pars = 
            {
                ...
                new OleDbParameter("@costPrice",OleDbType.Double),
                new OleDbParameter("@unitPrice",OleDbType.Double),
                new OleDbParameter("@note",OleDbType.VarChar,50),
            };
            pars[0].Value = purchaseID;
        ...
        #region 更新销售相关数据
        private TransactionModel<OleDbParameter> UpDatePurchaseTran(Purchase newPurchase, Purchase oldPurchase)
        {
        ...
        private TransactionModel<OleDbParameter> UpdatePurchaseDetailTran(string purchaseID, PurchaseDetailItem item)
        {
        ...
        public bool ApprovePurchaseItem(Purchase purchase, ObservableCollection<PurchaseDetailItem> purchaseItemCollection)
        {
            ...
            OleDbParameter[] pars = 
            {
                new OleDbParameter("@approved",OleDbType.Boolean),
                new OleDbParameter("@purchaseID",OleDbType.VarChar,50),
            };
            pars[0].Value = 1;
            pars[1].Value = purchase.PurchaseID;

            trans.Add(new TransactionModel<OleDbParameter>(sql, pars));
            return helper.ExecuteTransaction(trans);
        }
    }
    #endregion
    ...
    public partial class OleDbCommon
    {
        ...
        private List<TransactionModel<OleDbParameter>> UpdateSaleDetailTrans(
            string saleID,
            ObservableCollection<SaleDetailItem> newSaleItemCollection,
            ObservableCollection<SaleDetailItem> oldSaleItemCollection)
        {
        ...
        private List<TransactionModel<OleDbParameter>> UpdateServiceDetailTrans(
            string saleID,
            ObservableCollection<ServiceDetailItem> newServiceItemCollection,
            ObservableCollection<ServiceDetailItem> oldServiceItemCollection)
        {
        ...
        #region 删除销售单相关数据        
        private TransactionModel<OleDbParameter> DeleteSale(string saleID)
        {
            string sql = "Delete From Sale Where SaleID = @saleID";
            OleDbParameter[] pars = 
            {
                new OleDbParameter("@saleID",OleDbType.VarChar,50),
            };
            pars[0].Value = saleID;
            return new TransactionModel<OleDbParameter>(sql, pars);
        }
        private TransactionModel<OleDbParameter> DeleteSaleDetail(string saleID, int productID)
        {
        ...
        private TransactionModel<OleDbParameter> DeleteSaleDetail(string saleID)
        {
        ...
        private TransactionModel<OleDbParameter> DeleteServiceDetail(string saleID)
        {
        ...
        private TransactionModel<OleDbParameter> DeleteServiceDetail(string saleID, int serviceID)
        {
            string sql = "Delete From ServiceDetail Where SaleID = @saleID And ServiceID = @serviceID";
            OleDbParameter[] pars = 
            {
                new OleDbParameter("@saleID",OleDbType.VarChar,50),
                new OleDbParameter("@serviceID",OleDbType.Integer),
            };
            pars[0].Value = saleID;
        ...
        #region 插入新销售单相关数据        
        private TransactionModel<OleDbParameter> InsertSale(Sale sale)
        {
            ...
            OleDbParameter[] pars = 
            {
                ...
                new OleDbParameter("@attendantID",OleDbType.Integer),
                new OleDbParameter("@saleDate",OleDbType.Date),
                new OleDbParameter("@manufacturerID",OleDbType.Integer),
                new OleDbParameter("@machineID",OleDbType.VarChar,50),
                new OleDbParameter("@engineID",OleDbType.VarChar,50),
                new OleDbParameter("@note",OleDbType.VarChar,50),
            };
        ...
        private TransactionModel<OleDbParameter> InsertSaleDetail(string saleID, SaleDetailItem item)
        {
        ...
        private TransactionModel<OleDbParameter> InsertServiceDetail(string saleID, ServiceDetailItem item)
        {
        ...
        #region 更新销售相关数据
        private TransactionModel<OleDbParameter> UpDateSaleTran(Sale newSale, Sale oldSale)
        {
        ...
        private TransactionModel<OleDbParameter> UpdateSaleDetailTran(string saleID, SaleDetailItem item)
        {
        ...
        private TransactionModel<OleDbParameter> UpdateServiceDetailTran(string saleID, ServiceDetailItem item)
        {
    ...
    public partial class OleDbCommon
    {
        ...
        public bool SaveProduct(Product product)
        {
            ...
            if (product.ProductID == -1)
            {
                if (GetProductByPDM(product.PDM) == null)
                {
                    ...
                    {
                        new OleDbParameter("@productID",OleDbType.Integer),
                        new OleDbParameter("@pdm",OleDbType.VarChar,50),
                        new OleDbParameter("@productName",OleDbType.VarChar,50),
                        new OleDbParameter("@py",OleDbType.VarChar,50),
                        new OleDbParameter("@category",OleDbType.VarChar,50),
        ...
        public TransactionModel<OleDbParameter> UpdateProduct(DetailItem item, Mode mode)
        {
            ...
            {
                    new OleDbParameter("@number",OleDbType.Integer),
                    new OleDbParameter("@newCostPrice",OleDbType.Double),
                    new OleDbParameter("@unitPrice",OleDbType.Double),
                    new OleDbParameter("@productID",OleDbType.Integer),
                    new OleDbParameter("@oldNumber",OleDbType.Integer),
            };
        ...
        public bool SaveService(Model.Service service)
        {
            ...
            if (service.ServiceID == -1)
            {
                if (GetServiceByName(service.ServiceName) == null)
                {
                    ...
                    {
                    new OleDbParameter("@category",OleDbType.VarChar,50),
                    new OleDbParameter("@serviceName",OleDbType.VarChar,50),
                    new OleDbParameter("@unitPrice",OleDbType.Double),
                    };
            ...
            if (supplier.SupplierID == -1)
            {
                if (GetSupplierByName(supplier.SupplierName) == null)
                {
                    ...
                    pars = new OleDbParameter[]
                    {
                        ...
                        new OleDbParameter("@phoneNumber",OleDbType.VarChar,50),
                    };
        ...
        public bool SaveCharge(Charge charge)
        {
            ...
            if (charge.ChargeID == -1)
            {
                ...
                pars = new OleDbParameter[]
                {
                    new OleDbParameter("@chargeID",OleDbType.Integer),
                    new OleDbParameter("@chargeName",OleDbType.VarChar,50),
                    new OleDbParameter("@unit",OleDbType.VarChar,50),
                    new OleDbParameter("@unitPrice",OleDbType.Double),
                    new OleDbParameter("@number",OleDbType.Integer),
                    new OleDbParameter("@payDate",OleDbType.Date),
                    new OleDbParameter("@category",OleDbType.VarChar,50),
                    new OleDbParameter("@attendantName",OleDbType.VarChar,50),
                };
        ...
        public bool SaveCustomer(Customer customer)
        {
            ...
            if (customer.CustomerID == -1)
            {
                if (GetCustomerByName(customer.CustomerName) == null)
                {
                    ...
                    {
                        new OleDbParameter("@customerID",OleDbType.Integer),
                        new OleDbParameter("@customerName",OleDbType.VarChar,50),
                        new OleDbParameter("@py",OleDbType.VarChar,50),
                        new OleDbParameter("@address",OleDbType.VarChar,50),
                        new OleDbParameter("@contact",OleDbType.VarChar,50),
                        new OleDbParameter("@phoneNumber",OleDbType.VarChar,50),
