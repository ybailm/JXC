...
{
    public partial class SQLiteCommon : ICommon
    {
        readonly IHelper<SQLiteParameter, TransactionModel<SQLiteParameter>> helper = new SQLiteHelper();
    ...
    #region 入库
    public partial class SQLiteCommon
    {
        public bool InsertPurchase(Purchase purchase,
            ObservableCollection<PurchaseDetailItem> purchaseItemCollection)
        {
            List<TransactionModel<SQLiteParameter>> trans = new List<TransactionModel<SQLiteParameter>>();
        ...
        {
            var trans = new List<TransactionModel<SQLiteParameter>>();
        ...
        private List<TransactionModel<SQLiteParameter>> UpdatePurchaseDetailTrans(
            string purchaseID,
            ObservableCollection<PurchaseDetailItem> newPurchaseItemCollection,
            ObservableCollection<PurchaseDetailItem> oldPurchaseItemCollection)
        {
        ...
        #region 删除入库单相关数据        
        private TransactionModel<SQLiteParameter> DeletePurchase(string purchaseID)
        {
            string sql = "Delete From Purchase Where PurchaseID = @purchaseID";
            SQLiteParameter[] pars = 
            {
                new SQLiteParameter("@purchaseID",DbType.String,50),
            };
            pars[0].Value = purchaseID;
            return new TransactionModel<SQLiteParameter>(sql, pars);
        }
        private TransactionModel<SQLiteParameter> DeletePurchaseDetail(string purchaseID, int productID)
        {
            string sql = "Delete From PurchaseDetail Where PurchaseID = @purchaseID And ProductID = @productID";
            SQLiteParameter[] pars = 
            {
                new SQLiteParameter("@purchaseID",DbType.String,50),
                new SQLiteParameter("@productID",DbType.UInt32),
            };
            pars[0].Value = purchaseID;
            pars[1].Value = productID;
            return new TransactionModel<SQLiteParameter>(sql, pars);
        }
        private TransactionModel<SQLiteParameter> DeletePurchaseDetail(string purchaseID)
        {
        ...
        #region 插入新入库单相关数据        
        private TransactionModel<SQLiteParameter> InsertPurchase(Purchase purchase)
        {
            ...
            {
                new SQLiteParameter("@purchaseID",DbType.String,50),
                new SQLiteParameter("@supplierID",DbType.UInt32),
                new SQLiteParameter("@attendantID",DbType.UInt32),
                new SQLiteParameter("@purchaseDate",DbType.Date),
                new SQLiteParameter("@note",DbType.String,50),
            };
        ...
        private TransactionModel<SQLiteParameter> InsertPurchaseDetail(string purchaseID, PurchaseDetailItem item)
        {
            ...
            SQLiteParameter[] pars = 
            {
                new SQLiteParameter("@purchaseID",DbType.String,50),
                new SQLiteParameter("@productID",DbType.UInt32),
                new SQLiteParameter("@number",DbType.UInt32),
                new SQLiteParameter("@costPrice",DbType.Double),
        ...
        #region 更新销售相关数据
        private TransactionModel<SQLiteParameter> UpDatePurchaseTran(Purchase newPurchase, Purchase oldPurchase)
        {
        ...
        private TransactionModel<SQLiteParameter> UpdatePurchaseDetailTran(string purchaseID, PurchaseDetailItem item)
        {
        ...
        public bool ApprovePurchaseItem(Purchase purchase, ObservableCollection<PurchaseDetailItem> purchaseItemCollection)
        {
            ...
            SQLiteParameter[] pars = 
            {
                new SQLiteParameter("@approved",DbType.Boolean),
                new SQLiteParameter("@purchaseID",DbType.String,50),
            };
            pars[0].Value = 1;
            pars[1].Value = purchase.PurchaseID;

            trans.Add(new TransactionModel<SQLiteParameter>(sql, pars));
            return helper.ExecuteTransaction(trans);
        }
    }
    #endregion
    ...
    public partial class SQLiteCommon
    {
        ...
        private List<TransactionModel<SQLiteParameter>> UpdateSaleDetailTrans(
            string saleID,
            ObservableCollection<SaleDetailItem> newSaleItemCollection,
            ObservableCollection<SaleDetailItem> oldSaleItemCollection)
        {
        ...
        private List<TransactionModel<SQLiteParameter>> UpdateServiceDetailTrans(
            string saleID,
            ObservableCollection<ServiceDetailItem> newServiceItemCollection,
            ObservableCollection<ServiceDetailItem> oldServiceItemCollection)
        {
        ...
        #region 删除销售单相关数据        
        private TransactionModel<SQLiteParameter> DeleteSale(string saleID)
        {
            string sql = "Delete From Sale Where SaleID = @saleID";
            SQLiteParameter[] pars = 
            {
                new SQLiteParameter("@saleID",DbType.String,50),
            };
            pars[0].Value = saleID;
            return new TransactionModel<SQLiteParameter>(sql, pars);
        }
        private TransactionModel<SQLiteParameter> DeleteSaleDetail(string saleID, int productID)
        {
        ...
        private TransactionModel<SQLiteParameter> DeleteSaleDetail(string saleID)
        {
        ...
        private TransactionModel<SQLiteParameter> DeleteServiceDetail(string saleID)
        {
        ...
        private TransactionModel<SQLiteParameter> DeleteServiceDetail(string saleID, int serviceID)
        {
            string sql = "Delete From ServiceDetail Where SaleID = @saleID And ServiceID = @serviceID";
            SQLiteParameter[] pars = 
            {
                new SQLiteParameter("@saleID",DbType.String,50),
                new SQLiteParameter("@serviceID",DbType.UInt32),
            };
            pars[0].Value = saleID;
        ...
        #region 插入新销售单相关数据        
        private TransactionModel<SQLiteParameter> InsertSale(Sale sale)
        {
            ...
            {
                new SQLiteParameter("@saleID",DbType.String,50),
                new SQLiteParameter("@customerID",DbType.UInt32),
                new SQLiteParameter("@attendantID",DbType.UInt32),
                new SQLiteParameter("@saleDate",DbType.Date),
                new SQLiteParameter("@manufacturerID",DbType.UInt32),
                new SQLiteParameter("@machineID",DbType.String,50),
                new SQLiteParameter("@engineID",DbType.String,50),
                new SQLiteParameter("@note",DbType.String,50),
            };
        ...
        private TransactionModel<SQLiteParameter> InsertSaleDetail(string saleID, SaleDetailItem item)
        {
        ...
        private TransactionModel<SQLiteParameter> InsertServiceDetail(string saleID, ServiceDetailItem item)
        {
        ...
        #region 更新销售相关数据
        private TransactionModel<SQLiteParameter> UpDateSaleTran(Sale newSale, Sale oldSale)
        {
        ...
        private TransactionModel<SQLiteParameter> UpdateSaleDetailTran(string saleID, SaleDetailItem item)
        {
        ...
        private TransactionModel<SQLiteParameter> UpdateServiceDetailTran(string saleID, ServiceDetailItem item)
        {
    ...
    public partial class SQLiteCommon
    {
        ...
        public bool SaveProduct(Product product)
        {
            ...
            if (product.ProductID == -1)
            {
                if (GetProductByPDM(product.PDM) == null)
                {
                    ...
                    pars = new SQLiteParameter[]
                    {
                        new SQLiteParameter("@productID",DbType.UInt32),
                        new SQLiteParameter("@pdm",DbType.String,50),
                        new SQLiteParameter("@productName",DbType.String,50),
                        new SQLiteParameter("@py",DbType.String,50),
                        new SQLiteParameter("@category",DbType.String,50),
                        new SQLiteParameter("@unit",DbType.String,50),
                        new SQLiteParameter("@number",DbType.UInt32),
                        new SQLiteParameter("@unitPrice",DbType.Double),
                        new SQLiteParameter("@costPrice",DbType.Double),
                    };
        ...
        public TransactionModel<SQLiteParameter> UpdateProduct(DetailItem item, Mode mode)
        {
            ...
            {
                    new SQLiteParameter("@number",DbType.UInt32),
                    new SQLiteParameter("@newCostPrice",DbType.Double),
                    new SQLiteParameter("@unitPrice",DbType.Double),
                    new SQLiteParameter("@productID",DbType.UInt32),
                    new SQLiteParameter("@oldNumber",DbType.UInt32),
            };
        ...
        public bool SaveService(Model.Service service)
        {
            ...
            if (service.ServiceID == -1)
            {
                if (GetServiceByName(service.ServiceName) == null)                   
                {
                    ...
                    {
                        new SQLiteParameter("@category",DbType.String,50),
                        new SQLiteParameter("@serviceName",DbType.String,50),
                        new SQLiteParameter("@unitPrice",DbType.Double),
                    };
        ...
        public bool SaveSupplier(Supplier supplier)
        {
            ...
            if (supplier.SupplierID == -1)
            {
                if (GetSupplierByName(supplier.SupplierName) == null)                    
                {
                    ...
                    {
                        new SQLiteParameter("@supplierID",DbType.UInt32),
                        new SQLiteParameter("@supplierName",DbType.String,50),
                        new SQLiteParameter("@py",DbType.String,50),
                        new SQLiteParameter("@address",DbType.String,50),
                        new SQLiteParameter("@contact",DbType.String,50),
                        new SQLiteParameter("@phoneNumber",DbType.String,50),
                    };
        ...
        public bool SaveCharge(Charge charge)
        {
            ...
            if (charge.ChargeID == -1)
            {
                ...
                pars = new SQLiteParameter[]
                {
                    new SQLiteParameter("@chargeID",DbType.UInt32),
                    new SQLiteParameter("@chargeName",DbType.String,50),
                    new SQLiteParameter("@unit",DbType.String,50),
                    new SQLiteParameter("@unitPrice",DbType.Double),
                    new SQLiteParameter("@number",DbType.UInt32),
                    new SQLiteParameter("@payDate",DbType.Date),
                    new SQLiteParameter("@category",DbType.String,50),
                    new SQLiteParameter("@attendantName",DbType.String,50),
                };
        ...
        public bool SaveCustomer(Customer customer)
        {
            ...
            if(customer.CustomerID == -1)
            {
                if (GetCustomerByName(customer.CustomerName) == null)
                {
                    ...
                    {
                        new SQLiteParameter("@customerID",DbType.UInt32),
                        new SQLiteParameter("@customerName",DbType.String,50),
                        new SQLiteParameter("@py",DbType.String,50),
                        new SQLiteParameter("@address",DbType.String,50),
                        new SQLiteParameter("@contact",DbType.String,50),
                        new SQLiteParameter("@phoneNumber",DbType.String,50),
